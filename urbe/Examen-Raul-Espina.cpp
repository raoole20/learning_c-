...
int main(){
	...
	//calcular el promedio de los d�as
	for(int i = 0; i < 7; i++){
	...
	cout << promedio_a << endl;
	cout << promedio_b << endl;

	double promedio_aUSD = promedio_a / priceDolar;
	double fivePorciento_a = promedio_aUSD * 0.5;  // con respecto al 5% se evalaru� si es indiferente

	cout <<  promedio_aUSD << endl;
	cout << fivePorciento_a << endl;
